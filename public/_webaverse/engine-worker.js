import { injectQuery as __vite__injectQuery } from "/@vite/client";import { bindCanvas } from '/renderer.js';

const isTransferable = o => {
  const ctor = o?.constructor;
  return ctor === MessagePort || ctor === ImageBitmap || ctor === ImageData || // ctor === AudioData ||
  // ctor === OffscreenCanvas ||
  ctor === ArrayBuffer || ctor === Uint8Array || ctor === Int8Array || ctor === Uint16Array || ctor === Int16Array || ctor === Uint32Array || ctor === Int32Array || ctor === Float32Array || ctor === Float64Array;
};
...
async function import2(s) {
  ...
  try {
    const m = await import(__vite__injectQuery(s, 'import'));
    return m;
  } catch (err) {
...
export const contentId = "/app/engine-worker.js";
export const name = "engine-worker";
