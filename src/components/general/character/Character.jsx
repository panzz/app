...
const emotions = ['joy', 'sorrow', 'angry', 'fun', 'surprise'];
const mainStatSpecs = [
  {
      ...
      if (document.pointerLockElement === emotionsEl) {
        ...
        if (dragEmotionIndex !== -1) {
          ...
          if (value > 0) {
            ...
            const emoteActionIndex = localPlayer.findActionIndex(
              a => a.type === 'emote' && a.emotion === emotion,
            );
  ...
  return (
    <div
      className={classnames(
        ...
        state.openedPanel === 'CharacterPanel' ? styles.opened : null,
      )}
      onDrop={onDrop}
    >
      ...
      <div className={styles.characterPanel}>
        ...
        <div
          className={classnames(
            styles.selectButton,
            characterSelectOpen ? styles.highlight : null,
          )}
